...
function Role(props) {
    ...
    return (
        <Box className={props.toggleMode ? 'bg-gradient-to-b from-black via-purple-900 to-slate-900 h-96' : 'bg-gradient-to-b from-black via-gray-200 to-gray-50 h-96'} sx={{ width: "100%" }}>
            <Card className={props.toggleMode ? 'absolute md:left-10 md:right-10 left-0 right-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900 to-indigo-500 rounded-full p-4' :
                'bg-gradient-to-bl from-indigo-900 via-indigo-400 to-indigo-900 absolute md:left-10 md:right-10 left-0 right-0 rounded-full p-4'}
                ...
                {/* <Typography className='text-center px-4 text-white font-serif pt-1'>I am really interested to explore this fields.</Typography> */}
