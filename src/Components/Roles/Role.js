...
function Role(props) {
    ...
    return (
        <Box className={props.toggleMode ? 'bg-gradient-to-b from-black via-purple-900 to-slate-900' : 'bg-gradient-to-b from-black via-slate-400 to-gray-300'} sx={{ width: "100%", height: "60vh" }}>
